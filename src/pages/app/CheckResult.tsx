    ...
    <AppShell>
      <div className="grid lg:grid-cols-[1fr_320px] gap-6">
        <div className="space-y-5">
          <div className="lt-card p-6">
            <div className="flex items-center justify-between flex-wrap gap-3">
              <div>
                ...
                <h1 className="font-display text-3xl mt-1">2 / 3 marks</h1>
              </div>
            ...
            <p className="text-sm text-muted-foreground mt-2">Examiner-style estimate. Not an official board result.</p>
          </div>

          <div className="lt-card p-5">
            <div className="text-sm font-medium mb-3">Annotated steps</div>
            <ol className="space-y-3 text-sm">
              {steps.map((s, i) => {
                const Icon = s.kind === "ok" ? CheckCircle2 : s.kind === "partial" ? MinusCircle : AlertTriangle;
                const tone = s.kind === "ok" ? "text-primary" : s.kind === "partial" ? "text-[hsl(var(--warn))]" : "text-destructive";
                return (
          ...
          <div className="lt-card p-5">
            <div className="text-sm font-medium mb-3">Mistake summary</div>
            ...
            <div className="mt-4 rounded-lg lt-soft px-3 py-2 text-sm">
        ...
        <aside className="space-y-4">
          <div className="lt-card p-5">
            <div className="text-sm font-medium mb-2">Save state</div>
            {signedIn ? (
              <div className="rounded-lg lt-soft px-3 py-2 text-sm">Saved to Mistake Intelligence</div>
            ) : (
